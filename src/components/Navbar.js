  ...
  return <nav className="py-4 md:py-4">
   <div className="px-4 md:px-4 flex items-center justify-between">
     ...
     <div className="flex flex-row justify-center items-center space-x-4">
        ...
        <a className="font-medium text-gray-500 hover:text-gray-900 transition-colors  cursor-pointer" href="https://startup-template-app.vercel.app/signin">Sign in</a>
        <a className="rounded-md py-4 bg-gray-900 px-4 text-sm font-medium text-gray-50 shadow transition-colors hover:bg-gray-900/90" href="https://startup-template-app.vercel.app/signup">Start free trial</a>
     </div>
